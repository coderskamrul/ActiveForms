...
export default function Builder({ formId }) {
  ...
  const openPreview = useCallback(async () => {
    ...
    window.open(`${base}?radiusforms_preview=${idRef.current}`, '_blank', 'noopener');
  }, [dirty, save, notify]);
  ...
  return (
    <div className="radiusforms-builder-shell">
      <BuilderTopbar
        title={title}
        onTitle={setTitle}
      ...
      <DndContext sensors={sensors} collisionDetection={closestCenter} onDragStart={onDragStart} onDragEnd={onDragEnd} onDragCancel={() => setDrag(null)}>
          <div className="radiusforms-builder-2">
            <Canvas
              fields={fields}
          ...
          <DragOverlay dropAnimation={{ duration: 180, easing: 'cubic-bezier(0.2, 0, 0, 1)' }}>
            {drag ? (
              <div className="radiusforms-drag-ghost">
